...
import DxFunnelChartComponent, {
  DxFunnelChartComponentProps,
} from "components/designSystems/appsmith/DxFunnelChartComponent";
...
class DxFunnelChartWidget extends BaseWidget<
  DxFunnelChartWidgetProps,
  WidgetState
> {
  constructor(props: DxFunnelChartWidgetProps) {
    super(props);
    this.state = {
      text: props.text,
    };
  ...
  getPageView() {
    ...
    const conditionalProps: Partial<DxFunnelChartComponentProps> = {};
...
export interface DxFunnelChartWidgetProps extends WidgetProps, WithMeta {
  defaultText?: string;
  isDisabled?: boolean;
  text: string;
  regex?: string;
...
export default DxFunnelChartWidget;
export const ProfiledDxFunnelChartWidget = Sentry.withProfiler(
  withMeta(DxFunnelChartWidget),
);
