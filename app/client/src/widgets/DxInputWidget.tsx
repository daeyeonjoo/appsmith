...
import DxInputComponent, {
  DxInputComponentProps,
} from "components/designSystems/appsmith/DxInputComponent";
...
class DxInputWidget extends BaseWidget<DxInputWidgetProps, WidgetState> {
  constructor(props: DxInputWidgetProps) {
    super(props);
    this.state = {
      text: props.text,
    };
  ...
  getPageView() {
    ...
    const conditionalProps: Partial<DxInputComponentProps> = {};
...
export interface DxInputWidgetProps extends WidgetProps, WithMeta {
  inputType: InputType;
  defaultText?: string;
  isDisabled?: boolean;
  text: string;
...
export default DxInputWidget;
export const ProfiledDxInputWidget = Sentry.withProfiler(
  withMeta(DxInputWidget),
);
