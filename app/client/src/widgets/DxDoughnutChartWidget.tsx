...
import DxDoughnutChartComponent, {
  DxDoughnutChartComponentProps,
} from "components/designSystems/appsmith/DxDoughnutChartComponent";
...
class DxDoughnutChartWidget extends BaseWidget<
  DxDoughnutChartWidgetProps,
  WidgetState
> {
  constructor(props: DxDoughnutChartWidgetProps) {
    super(props);
    this.state = {
      text: props.text,
    };
  ...
  getPageView() {
    ...
    const conditionalProps: Partial<DxDoughnutChartComponentProps> = {};
  ...
  getWidgetType(): WidgetType {
    return "DX_DOUGHNUT_CHART_WIDGET";
  }
}
...
export interface DxDoughnutChartWidgetProps extends WidgetProps, WithMeta {
  inputType: InputType;
  defaultText?: string;
  isDisabled?: boolean;
  text: string;
...
export default DxDoughnutChartWidget;
export const ProfiledDxDoughnutChartWidget = Sentry.withProfiler(
  withMeta(DxDoughnutChartWidget),
);
