...
export enum WidgetTypes {
  DX_BUTTON_WIDGET = "DX_BUTTON_WIDGET",
  ...
  DX_INPUT_WIDGET = "DX_INPUT_WIDGET",
  DX_DOUGHNUT_CHART_WIDGET = "DX_DOUGHNUT_CHART_WIDGET",
  DX_FUNNEL_CHART_WIDGET = "DX_FUNNEL_CHART_WIDGET",
}
