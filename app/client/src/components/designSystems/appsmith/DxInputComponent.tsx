...
class DxInputComponent extends React.Component<
  DxInputComponentProps,
  DxInputComponentState
> {
  constructor(props: DxInputComponentProps) {
    super(props);
...
export interface DxInputComponentState {
  showPassword?: boolean;
}

export interface DxInputComponentProps extends ComponentProps {
  value: string;
  inputType: InputType;
  disabled?: boolean;
  intent?: Intent;
